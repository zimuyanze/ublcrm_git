		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="alert alert-block alert-success">
					...
					为了您更好的使用本系统，建议屏幕分辨率 <b>1280*768</b> 以上，并且安装chrome谷歌浏览器 ——— <a href="<?php echo url('admin/Help/soft'); ?>">进入软件下载专区</a>
				</div>
				<div class="row">
